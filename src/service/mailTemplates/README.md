# Email template filler (used in mailService)
https://cheatcode.co/tutorials/how-to-send-email-with-nodemailer


# Free Responsive HTML Email Template (another example - not used in this client)
...
Use the template `template.html` as is. They'll put the CSS inline for you when you put together your campaign.
